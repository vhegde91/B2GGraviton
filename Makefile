...
SOURCES = NtupleVariables.cc SignalRegGraviton.cc 
HEADERS = NtupleVariables.h SignalRegGraviton.h 
OBJECTS = $(SOURCES:.cc=.o)

EXECUTABLE = signalRegGraviton
...
SignalRegGraviton.o:NtupleVariables.h SignalRegGraviton.h
