...
// Tue May  7 08:52:56 2019 by ROOT version 6.10/09
// from TTree tree/all observables, signal
// found on file: /eos/uscms/store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV17/tree_signal/tree_ZJetsToNuNu_HT-100to200_MC2016.root
//////////////////////////////////////////////////////////
...
#ifdef V17skims_cxx
V17skims::V17skims(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV17/tree_signal/tree_ZJetsToNuNu_HT-100to200_MC2016.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV17/tree_signal/tree_ZJetsToNuNu_HT-100to200_MC2016.root");
      }
...
Int_t V17skims::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t V17skims::LoadTree(Long64_t entry)
{
...
void V17skims::Show(Long64_t entry)
{
...
Int_t V17skims::Cut(Long64_t entry)
{
